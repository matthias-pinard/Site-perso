  ...
  return (
    <div className="max-w-md min-w-sm lg:max-w-full lg:flex flex-1 m-4 shadow-xl self-stretch">
      ...
      <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
        ...
        <p className="text-gray-700 text-sm mb-4 text-justify">{projet.description}</p>
        <div className="flex justify-around max-w-full">
          {projet.video && <FontAwesomeIcon icon={faYoutube} size="lg"/>}
          {projet.github && <FontAwesomeIcon icon={faGithub} size="lg"/>}
          {projet.website && <FontAwesomeIcon icon={faGlobe} size="lg"/>}
        </div>
      </div>
    </div>
  )
